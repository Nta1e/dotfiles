...
script=$(plutil -extract ProgramArguments.0 raw -o - ~/Library/LaunchAgents/org.nix-community.home.hermes.plist)
...
run sh -c 'mkdir -p /opt/data/ssh && cat > /opt/data/ssh/id_ed25519 && chmod 600 /opt/data/ssh/id_ed25519' \
